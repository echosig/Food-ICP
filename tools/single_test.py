...
def main():
    ...
    parser.add_argument('--img', default='D:/ybj/Awesome-Backbones-main/34_22_bear_row_img/test/Outer_ring/32_22_62_1.jpg', help='Image file')
    parser.add_argument('--config', default='D:/ybj/Awesome-Backbones-main/models/seresnext/seresnext50.py', help='Config file')
    parser.add_argument(
        '--classes-map', default='D:/ybj/Awesome-Backbones-main/datas/annotations.txt', help='classes map of datasets1')
    parser.add_argument(
